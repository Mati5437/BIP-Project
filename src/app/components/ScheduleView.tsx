...
export function ScheduleView({ username, ageGroup, onJoinSession }: ScheduleViewProps) {
  ...
  // useState keeps generated mock times stable while this screen is open
    ...
    <div style={{
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '18px',
                      padding: '14px',
                      border: enrolled ? '2px solid #14B8A6' : '1px solid #E2E8F0'
                    }}
                  >
                    <div style={{
                      display: 'flex',
          ...
          {myNextSession && (
            <div style={{
              ...
              <p style={{
                ...
                {myNextSession.icon} {myNextSession.title}
              </p>
              ...
              <p style={{
                ...
                {formatSessionTime(myNextSession.startTime)} - {formatSessionTime(myNextSession.endTime)}
              </p>
            </div>
          )}
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Select a day to see available lessons.
            </p>
          </div>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                background: calendarOffset === 0 ? '#DBEAFE' : '#F8FAFC',
                color: calendarOffset === 0 ? '#2563EB' : '#64748B'
              }}
            >
              Today
            </button>
          ...
          {calendarDays.map((day) => {
            ...
            return (
              <button
                ...
                style={{
                  border: isSelected ? '3px solid #14B8A6' : '1px solid #E2E8F0',
      ...
      <div style={{
        ...
        {[
          ...
          <button
            key={item.id}
            onClick={() => setFilter(item.id as ScheduleFilter)}
            style={{
              border: 'none',
              borderRadius: '14px',
              padding: '12px 18px',
            ...
            return (
              ...
              >
                ...
                <h3 style={{
                  ...
                  color: '#1E293B',
                  fontWeight: '900',
                  paddingRight: status === 'live' || enrolled ? '90px' : 0
                }}>
                  {session.title}
                </h3>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    Host: <strong style={{ color: '#1E293B' }}>{session.host}</strong>
                  </div>

                  {status === 'live' && enrolled ? (
                    <button onClick={onJoinSession} style={primaryButtonStyle}>
                      <PlayCircle size={17} />
                      Join
                    </button>
                  ) : status === 'live' && !enrolled ? (
...
const secondaryDangerButtonStyle: CSSProperties = {
  border: 'none',
  borderRadius: '14px',
  padding: '11px 15px',
  fontSize: '14px',
